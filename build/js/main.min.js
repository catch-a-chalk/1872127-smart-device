...
/* harmony import */ var _modules_modals_init_accordeon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/init-accordeon */ "./js/modules/modals/init-accordeon.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_init_accordeon__WEBPACK_IMPORTED_MODULE_2__["initAccordeon"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var accordeonActiveted = document.querySelector('.main-about__accordeon--is-active');
var accordeonDisabled = document.querySelector('.main-about__accordeon--is-disabled');

var initAccordeon = function initAccordeon() {
  document.querySelectorAll('.main-about__trigger').forEach(function (item) {
    return item.addEventListener('click', function () {
      var parent = item.parentNode;
      document.querySelectorAll('.main-about__accordeon').forEach(function (child) {
        return child.classList.remove(accordeonDisabled);
      });
